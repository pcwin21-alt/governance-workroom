...
- Decision: 자료실의 `전체 기록 / 파일 관리 / 역대 기록` 소메뉴를 하나의 `자료실` 화면으로 합쳤다. 정책 제안서 작성에서 이슈 연결과 AI 작성 도움을 제거하고, 아카이브 보관 후보에서도 이슈·공지를 제외했다. 회의·참석·결정, 정책 제안·피드백·기관 회신, 기록 보관·DOCX/PDF 내보내기, 내 활동·계정은 유지한다.
